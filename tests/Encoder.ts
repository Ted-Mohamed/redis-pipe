import { Array, ArraySize, BulkString, SimpleString, Integer, Error } from '../source/Encoder'
...
test('Correctly encode an array of strings', () => {
    expect(Array([BulkString("foo"), BulkString("bar")])).toEqual("*2\r\n$3\r\nfoo\r\n$3\r\nbar\r\n")
})
...
test('Correctly encode a command', () => {
    ...
    let encodedCommand = command.reduce((o, c) => o + BulkString(c), ArraySize(command))
    expect(encodedCommand).toEqual("*3\r\n$3\r\nSET\r\n$3\r\nkey\r\n$5\r\nvalue\r\n")
})
